...
void BitcoinGUI::updateMintingIcon()
{
    ...
    {	
        ...
        {
            nEstimateTime = nTargetSpacing3 * nNetworkWeight / nWeight;
        }
        else if(GetAdjustedTime() > FORK_TIME)
        {
...
void BitcoinGUI::loadTheme(QString theme)
{
    ...
    if (theme != "HardDefault") {
		...
		"QWidget:item:selected {color:#02898f;background:#02898f;}"
		...
		"QMenuBar::item:selected {background: transparent;border: none;color:#02898f;}"
		"QMenuBar::item:pressed {color: #000;background-color:#02898f;}"
		...
		"QToolBar {background:#000;qproperty-iconSize: 128px 42px;border:none;border-bottom:1px solid #333;padding:10px;}"
		"QToolBar::handle {padding: 0px;background-repeat: repeat-y;background-position: top center;}"
		"QToolButton {qproperty-toolButtonStyle: ToolButtonIconOnly;border:none;border-radius:5px;padding:1px;margin:0px; }"
		...
		"QPushButton:hover {	color:#000;	background:#02898f;}"
		...
		"QProgressBar::chunk {	background:QLinearGradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5, stop: 0 #e5ca4d, stop: 1 #02898f);	border:none;	border-radius:2px;	margin:1px;}"
		...
		"QTabBar::tab:hover {	color: #000;	background:#02898f;}"
		"QTabBar::tab:selected {	color:#02898f;	background-color:#2a2a2a;	border-top-left-radius: 4px;	border-top-right-radius: 4px;}"
		...
		"QTreeView::item:hover {	color:#02898f;	background:transparent;}"
		"QTreeView::item:selected {	color:#000;		background:#02898f;}"
		"QAbstractItemView {	color:#02898f;	alternate-background-color: #151515;}"
		"QAbstractItemView::item:hover {	color:#02898f;}"
		...
		"#charityAddressEdit, #charityPercentEdit {	color:#02898f;	font-size:10px;	font-weight:600;}"
		"#StatisticsPage #label_5, #BlockBrowser #label_5, #ChatWindowClass #label_9, #ChatWindowClass #label_11, #ChatWindowClass #label_12, #charityDialog #label { 	color:#02898f;	background:transparent;	font-size:20px;	font-weight:600;}";
